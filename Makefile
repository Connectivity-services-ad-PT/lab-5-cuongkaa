...
build:
	docker build -t fit4110/access-gate:v1.0.0-team-gate .

# Run API container standalone (not via compose)
run:
	docker run --rm --name fit4110-access-gate -p 8000:8000 --env-file .env.example fit4110/access-gate:v1.0.0-team-gate
